...
final class GreenScreenPhotographyTextureOverride {
    private static final ResourceLocation SCREEN_TEXTURE = ResourceLocation.fromNamespaceAndPath(GreenScreenPhotography.MOD_ID, "block/green_screen_block");

    private GreenScreenPhotographyTextureOverride() {
    }
    ...
    static void restoreDefaultColor() {
        uploadColor(GreenScreenPhotographyBlock.DEFAULT_SCREEN_COLOR);
    }
