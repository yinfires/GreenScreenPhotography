...
public final class ModCreativeTabs {
    public static final DeferredRegister<CreativeModeTab> CREATIVE_MODE_TABS = DeferredRegister.create(Registries.CREATIVE_MODE_TAB, GreenScreenPhotography.MOD_ID);
    ...
    public static final Supplier<CreativeModeTab> GREEN_SCREEN_TAB = CREATIVE_MODE_TABS.register("green_screen", () -> CreativeModeTab.builder()
            .title(Component.translatable("itemGroup." + GreenScreenPhotography.MOD_ID + ".green_screen"))
